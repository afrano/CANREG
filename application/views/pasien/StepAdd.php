    ...
    <div class="col-sm-12">
        <div class="white-box">
            ...
            <div id="exampleValidator" class="wizard">
                ...
                <form id="validation" action="<?//= site_url('Pasien/tambah_pasien') ?>" class="form-horizontal " method="post">
...
<script type="text/javascript">
    (function () {
        $('#exampleValidator').wizard({
            ...
            onFinish: function () {
                $('#validation').submit();
                swal("Message Finish!", "Data Tersimpan");
            }
        });
    })();
</script>
...
if (isset($_POST['submit'])) { //jika button submit diklik maka panggil fungsi insert pada controller
    // $main = new JalanDAO();Pasien/tambah_pasien
    $main = new Pasien();
    $main->tambah_pasien();
}
?>