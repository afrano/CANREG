            ...
            <form class="row" action="<?= site_url('Pasien/tambah_pasien') ?>" method="POST" >
                <div class="col-sm-6">
                    <div class="white-box">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <select  class="custom-select col-12" id="inlineFormCustomSelect" name="ID_Provinsi">
                                    <?php
                        ...
                        <div class="form-group ">
                            <div class="col-sm-12">
                                <input class="form-control" readonly="" name="kode_pos" type="text" value="<?= $row->kode_pos ?>" >                           
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="white-box">
                        ...
                        <div class="form-group ">
                            <div class="col-sm-12">
                                <input class="form-control" readonly="" name="kode_pos" type="text" value="<?= $row->kode_pos1 ?>" >                           
                            </div>
                        </div>
                                ...
                                <select class="custom-select col-12" name="ID_Sex" id="inlineFormCustomSelect">
                                    ...
                                    foreach ($query->result() as $row1) {
                                        if ($row1->id_sex == $row->ID_Sex) {
                                            echo "<option selected value='$row1->id_sex'>$row1->id_sex &nbsp;$row1->sex</option>";
                                        } else {
                                            echo "null";
                                        }
                                    }
                                ...
                                <select class="custom-select col-12" name="ID_Race" id="inlineFormCustomSelect">
                                    ...
                                    foreach ($query->result() as $row1) {
                                        if ($row1->id_race == $row->ID_Race) {
                                            echo "<option selected value='$row1->id_race'>$row1->id_race &nbsp;$row1->race</option>";
                                        } else {
                                            echo "null";
                                        }
                                    }
                                ...
                                <select class="custom-select col-12" name="ID_Religion" id="inlineFormCustomSelect">
                                    ...
                                    foreach ($query->result() as $row1) {
                                        if ($row1->id_religion == $row->ID_Religion) {
                                            echo "<option selected value='$row1->id_religion'>$row1->id_religion &nbsp;$row1->religion</option>";
                                        } else {
                                            echo "null";
                                        }
                                    }
                                ...
                                <select class="custom-select col-12" name="ID_Status_Pernikahan" id="inlineFormCustomSelect">
                                    ...
                                    foreach ($query->result() as $row1) {
                                        if ($row1->id_hubungan == $row->id_status_hubungan) {
                                            echo "<option selected value='$row1->id_hubungan'>$row1->id_hubungan &nbsp;$row1->status_hubungan</option>";
                                        } else {
                                            echo "null";
                                        }
                                    }
                                ...
                                <select class="custom-select col-12" name="ID_Occupation" id="inlineFormCustomSelect">
                                    ...
                                    foreach ($query->result() as $row1) {
                                        if ($row1->id_occupation == $row->ID_Occupation) {
                                            echo "<option selected value='$row1->id_occupation'>$row1->id_occupation &nbsp;$row1->Occupation</option>";
                                        } else {
                                            echo "null";
                                        }
                                    }
                            ...
                            <tr>
                                <th><div class="form-check">
                                        <label class="form-check-label">
                                            ...
                                            foreach ($query->result() as $row1) {
                                                if ($row1->NIK == $row->NIK) {
                                                    echo ' <input type="checkbox" class="form-check-input" checked="checked" id="checkboxDanger" > &nbsp;' . $row1->ID_Diagnosis . '';
                                                } else {
                                                    echo "null";
                                                }
                                            }
                            ...
                            <tr>
                                <th><div class="form-check">
                                        <label class="form-check-label">
                                            ...
                                            foreach ($query->result() as $row1) {
                                                if ($row1->NIK == $row->NIK) {
                                                    echo ' <input type="checkbox" class="form-check-input" checked="checked" id="checkboxDanger" > &nbsp;' . $row1->No_Of_Metastases . '';
                                                } else {
                                                    echo "null";
                                                }
                                            }
