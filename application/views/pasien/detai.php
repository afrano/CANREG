                ...
                <div class="col-sm-6">
                    ...
                    <div class="white-box">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                                <input class="form-control" name="MRN" type="search" readonly=""  value="mrn" placeholder="Tujuh digit kode RS | NO MR" id="example-search-input">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="row">
                                <div class="col-lg-11">
                                    <div class="example">
                                        ...
                                        foreach ($query->result() as $row1) {
                                            if ($row1->NIK == $row->NIK) {
                                                echo ' <input type="search" value=' . $row1->Immunohistokimia . ' readonly=""   class="Morphology form-control nama" placeholder="Nama Morphology">';
                                            } else {
                                                echo "";
                                            }
                                        }
