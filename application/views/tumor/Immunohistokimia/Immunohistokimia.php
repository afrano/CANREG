    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><strong><center>Tambah Immunohistokimia </center></strong></h4>
            </div>
            <div class="modal-body">
                <form class="form-group" action="<?= site_url('Tumor/addImmunohistokimia') ?>" method="POST" >
                    <div class="form-group">
                        <label>Kode  :</label>
                        <input class="form-control" type="text" name="ID_Immunohistokimia" required="true" />
                    </div>
                    <div class="form-group">
                        <label>Nama  :</label>
                        <input class="form-control" type="text" name="Immunohistokimia" required="true" />
                    </div>
                    <div class='form-group'>
...
<div class="row">
    <div class="col-lg-12">
        <div class="white-box">
            ...
            <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle" data-page-size="7">
                ...
                <div class="form-inline padding-bottom-15">
                    <div class="col-sm-12 text-right m-b-20">
                        <h4><strong><center>Data Immunohistokimia</center></strong></h4>
                    </div>
                    <div class="row">
			...
			<tr>
				<td>$no</td>
				<td>$row->ID_Immunohistokimia</td>
				<td>$row->Immunohistokimia</td>
				<td>$row->Create_Date</td>
				<td>$row->Update_Date</td>
				<td >
					<a class='glyphicon glyphicon-pencil' 
					href='" . site_url("Tumor/ubahImmunohistokimia/$row->ID_Immunohistokimia") . "' >	</a>
					
					<a class='glyphicon glyphicon-trash' 
                                        onclick='return confirm(\"Data Akan Di Hapus\")'
					href='" . site_url("Tumor/hapusImmunohistokimia/$row->ID_Immunohistokimia") . "' >	</a>
