    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><strong><center>Tambah Treatment at reporting institution </center></strong></h4>
            </div>
            <div class="modal-body">
                <form class="form-group" action="<?= site_url('Tumor/addTeatmentReporting') ?>" method="POST" >
                    <div class="form-group">
                        <label>Kode  :</label>
                        <input class="form-control" type="text" name="ID_Treatment" required="true" />
                    </div>
                    <div class="form-group">
                        <label>Nama Treatment at reporting institution:</label>
                        <input class="form-control" type="text" name="Treatment_Reporting" required="true" />
                    </div>
                    <div class='form-group'>
    ...
    <div class="col-lg-12">
        <div class="white-box">
            ...
            <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle" data-page-size="7">
                ...
                <div class="form-inline padding-bottom-15">
                    <div class="col-sm-12 text-right m-b-20">
                        <h4><strong><center>Data Treatment at reporting institution</center></strong></h4>
                    </div>
                    <div class="row">
			...
			<tr>
				...
				<td>$row->Treatment_Reporting</td>
				<td>$row->Create_Date</td>
				<td>$row->Update_Date</td>
				<td >
					<a class='glyphicon glyphicon-pencil' 
					href='" . site_url("Tumor/ubahTeatmentReporting/$row->ID_Treatment") . "' >	</a>
					
					<a class='glyphicon glyphicon-trash' 
                                        onclick='return confirm(\"Data Akan Di Hapus\")'
					href='" . site_url("Tumor/hapusTeatmentReporting/$row->ID_Treatment") . "' >	</a>
