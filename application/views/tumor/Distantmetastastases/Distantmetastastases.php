    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><strong><center>Tambah Distant Metastases </center></strong></h4>
            </div>
            <div class="modal-body">
                <form class="form-group" action="<?= site_url('Tumor/addDistantmetastastases') ?>" method="POST" >
                    <div class="form-group">
                        <label>Kode  :</label>
                        <input class="form-control" type="text" name="ID_Distant_Metastases" required="true" />
                    </div>
                    <div class="form-group">
                        <label>Nama  :</label>
                        <input class="form-control" type="text" name="Distant_Metastases" required="true" />
                    </div>
                    <div class='form-group'>
...
<div class="row">
    <div class="col-lg-12">
        <div class="white-box">
            ...
            <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle" data-page-size="7">
                ...
                <div class="form-inline padding-bottom-15">
                    <div class="col-sm-12 text-right m-b-20">
                        <h4><strong><center>Data Distant metastastases</center></strong></h4>
                    </div>
                    <div class="row">
			...
			<tr>
				<td>$no</td>
				<td>$row->ID_Distant_Metastases</td>
				<td>$row->Distant_Metastases</td>
				<td>$row->Create_Date</td>
				<td>$row->Update_Date</td>
				<td >
					<a class='glyphicon glyphicon-pencil' 
					href='" . site_url("Tumor/ubahDistantmetastastases/$row->ID_Distant_Metastases") . "' >	</a>
					
					<a class='glyphicon glyphicon-trash' 
                                        onclick='return confirm(\"Data Akan Di Hapus\")'
					href='" . site_url("Tumor/hapusDistantmetastastases/$row->ID_Distant_Metastases") . "' >	</a>
