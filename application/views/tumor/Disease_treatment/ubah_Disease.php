...
<div class="row">
    <div class="col-lg-8 center-block">
        <div class="white-box">
            <a href="<?=  site_url('Tumor/Diseasetreatment')?>"> <<<< Back </a>
            ...
            if ($row == null) {
                ...
                <form class="form-group" action="<?= site_url($this->uri->uri_string()) ?>" method="POST">
                    <div class="form-group">
                        ...
                        <input class="form-control" value="<?= $row->ID_Disease ?>" name="ID_Disease" type="text" required="true" />
                    </div>
                    <div class="form-group">
                        <label>Diagnosis</label>
                        <input class="form-control" name="Disease" value="<?= $row->Disease ?>" required="true"/>
                    </div>
                    <div class='form-group'>
