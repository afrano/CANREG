    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><strong><center>Tambah Stage </center></strong></h4>
            </div>
            <div class="modal-body">
                <form class="form-group" action="<?= site_url('Tumor/addStage') ?>" method="POST" >
                    <div class="form-group">
                        <label>Kode  :</label>
                        <input class="form-control" type="text" name="ID_Stage" required="true" />
                    </div>
                    <div class="form-group">
                        <label>Nama  :</label>
                        <input class="form-control" type="text" name="Stage" required="true" />
                    </div>
                    <div class='form-group'>
        ...
        <div class="white-box">
            ...
            <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle" data-page-size="7">
                ...
                <div class="form-inline padding-bottom-15">
                    <div class="col-sm-12 text-right m-b-20">
                        <h4><strong><center>Data Stage</center></strong></h4>
                    </div>
                    <div class="row">
			...
			<tr>
				...
				<td >
					...
					href='" . site_url("Tumor/ubahStage/$row->ID_Stage") . "' >	</a>
					
					<a class='glyphicon glyphicon-trash' 
                                        onclick='return confirm(\"Data Akan Di Hapus\")'
					href='" . site_url("Tumor/hapusStage/$row->ID_Stage") . "' >	</a>
