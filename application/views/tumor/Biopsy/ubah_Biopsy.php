<div class="row">
    <div class="col-lg-8 center-block" >
        <div class="white-box">
            <a href="<?= site_url('Tumor/Biopsy') ?>"> <<<< Back </a>
            ...
            if ($row == null) {
                ...
                <form class="form-group" action="<?= site_url($this->uri->uri_string()) ?>" method="POST">
                    <div class="form-group">
                        <label>Kode :</label>
                        <input class="form-control" name="ID_Biopsy"  value="<?= $row->ID_Biopsy ?>" type="text" required="true" />
                    </div>
                    <div class="form-group">
                        <label>Nama </label>
                        <input class="form-control" name="Biopsy" value="<?= $row->Biopsy ?>" required="true"/>
                    </div>
                    <div class='form-group'>
